...
def make_markdown(cv_id):
    return  f"""::: iframe [**PHAROS Disease Summary:**](https://pharos.nih.gov/diseases/?id={cv_id}&width=1200&height=450){{width=\"1200\" height=\"450\" style=\"border: 1px solid black;\" caption-style=\"font-size: 24px;\" caption-link=\"https://pharos.nih.gov/diseases/?id={cv_id}" caption-target=\"_blank\"}} \n:::"""
