...
def main():
    ...
    with open(args.alias_file, 'r', newline='') as fp:
        ...
        for row in r:
            ...
            print(f"{cv_id}, {SYMBOL}") 
            
            alias_md = f"""::: iframe [**LINCS Chemical Perturbations (via LINCS API):**](https://appyters.maayanlab.cloud/L1000_RNAseq_Gene_Search/#?args.gene={SYMBOL}&submit){{width=\"1200\" height=\"450\" style=\"border: 1px solid black;\" caption-style=\"font-size: 24px;\" caption-link=\"v\" caption-target=\"_blank\"}} \n:::\n"""
